...
def check_collision(car_pos_cell, target_pos_cell):
...
def purepursuit_control_node(data):
    ...
    # ===== OBSTACLE CHECK: If obstacle is between car and target, stop =====
...
if __name__ == '__main__':
    ...
    try:
        ...
        # Initialize obstacle avoidance grid
        init_grid_params()
